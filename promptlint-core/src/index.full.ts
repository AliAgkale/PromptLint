...
import { runAllObservations, makeLangState, type LangState } from './analyzers/observations.js';
...
function buildResult(
  ...
  if (!text?.trim()) {
    return {
      ...
      tokens: analyzeTokens(''), score: { total: 0, label: 'poor', dimensions: {}, summary: 'Prompt vuoto.' },
  ...
  // Run observations — inject spell adapter
